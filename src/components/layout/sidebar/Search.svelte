...
>
    ...
    <span>Search...</span>
    <kbd
            class="bg-muted pointer-events-none absolute right-1.5 top-1.5 flex h-5 select-none items-center gap-1 rounded border px-1.5 font-mono text-[10px] font-medium opacity-100"
    >
